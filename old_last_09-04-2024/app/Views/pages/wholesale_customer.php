    ...
    <div class="container">
        <div class="text three_quarter align_center">
            ...
            <div class="message d-table" style="width: 100%">
                <?php get_message('contact_success') ?>
            </div>
            <br>
            <div class="text-block">
                <div role="form" lang="en-US" dir="ltr">
                    ...
                    <form action="<?php echo base_url('wholesale-request') ?>" method="post" novalidate="novalidate">

                        <div class="row">
                            <div class="col-md-6">
                                <!-- Request Wholesale Account -->
                                <input type="text" name="account_name" value="" size="40" class="form-control" aria-invalid="false" placeholder="Request Wholesale Account" />
                            </div>
                            <div class="col-md-6">
                                        <span class="coffee-usage">
                                        <input type="number" name="coffee_usage" value="" class="form-control" min="0" aria-invalid="false" placeholder="Estimated Weekly Coffee Usage (KG)" />
                                    </span>
                            </div>
                        </div>
                        ...
                        <div class="row pt-3">
                            <div class="col-md-6">
                                <!-- your name --->
                                <input type="text" name="your_name" value="" size="40" class="form-control" aria-required="true" aria-invalid="false" placeholder="full name*" />
                            </div>
                            <div class="col-md-6">
                                <!-- company name --->
                                <input type="text" name="company_name" value="" size="40" class="form-control" aria-invalid="false" placeholder="company name" />
                            </div>
                        </div>
                        ...
                        <div class="row pt-3">
                            <div class="col-md-6">
                                <!-- your number --->
                                <input type="text" name="your_number" value="" size="40" class="form-control" aria-invalid="false" placeholder="telephone number*" />
                            </div>
                            <div class="col-md-6">
                                <!-- email --->
                                <input type="email" name="your_email" value="" size="40" class="form-control" aria-required="true" aria-invalid="false" placeholder="email*" />
                            </div>
                        </div>
                        ...
                        <div class="row pt-3">
                            <div class="col-md-12">
                                <!-- your message -->
                                <textarea name="your_message" cols="40" rows="10" class="form-control" aria-invalid="false" placeholder="your message (optional)"></textarea>
                            </div>
                        </div>

                        <div class="c-1">
                            <!-- submit --->
                            <input type="submit" value="Send" class="form-control" /></p>
