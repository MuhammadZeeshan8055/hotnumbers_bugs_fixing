                            ...
                            <div class="input_field">
                                <div>
                                    <select class="select2" name="tax_shipping_class" value="<?php echo get_setting('tax_shipping_class') ?>">
                                        <option value="">Based on cart items</option>
                                        <?php
            ...
            function tax_table($tax_rates=[]) {
                if(!empty($tax_rates['tax_class_name'])) {
                    ...
                    <div class="input_field">
                        ...
                        <a href="#" data-name="<?php echo !empty($label_id) ? $label_id : '' ?>" onclick="append_tax_rate(this);return false" class="btn btn-sm save text-center d-block">Add Tax Rate</a>
                    </div>
                    <?php
                }
            }
