                            ...
                            <div id="subscription-types">
                                ...
                                if (empty($subscriptionForm['subscription-type'])) {
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4" style="position: relative">
                                            <div class="input_field">
                                                <input type="text" name="subscriptionForm[subscription-type][value][]" value="" placeholder="Value">
                                            </div>
                                        </div>
                                    ...
                                    foreach($subscriptionForm['subscription-type'] as $value=>$name) {
                                        ...
                                        <div class="row method-row">
                                            ...
                                            <div class="col-md-4" style="position: relative">
                                                <div class="input_field">
                                                    <input type="text" name="subscriptionForm[subscription-type][value][]" value="<?php echo $value ?>" placeholder="Value">
                                                </div>
