<section id="tab-shop">
    ...
    <form action="<?php echo base_url(ADMIN . '/settings') ?>"
        ...
        <div class="table-box">
            ...
            <h4 class="heading" style="margin-bottom: 14px;">Reduce price</h4>
            <div>
                <div>
                    <?php
            ...
            <div>
                <div>
                    ...
                    <div class="d-inline-block input_field" style="vertical-align: middle;">
                        <label>Discount</label>
                        <div class="mt-4">
                            <input class="form-control" min="0" type="number" name="global_discount[price]" value="<?php echo @$global_discount['price']?>">
                        </div>
                    </div>
                    <div class="d-inline-block input_field" style="vertical-align: middle;">
                        <label>Discount type</label>
                                ...
                                <div class="pb-20 flex" style="gap: 30px; align-items: center">
                                    ...
                                    <div class="d-inline-block input_field" style="vertical-align: top;">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <input class="form-control" min="0" type="number" name="user_discount[<?php echo $role->id ?>][role_discount]" value="<?php echo @$get_discount['role_discount']?>">
                                        </div>
                                    </div>
                                    <div class="d-inline-block input_field" style="vertical-align: top;">
                                        <label>Discount type</label>
