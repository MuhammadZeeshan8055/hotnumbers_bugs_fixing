    ...
    <div class="datatable">
        ...
        <form id="order-list" method="post">
            <div class="books_listing">
                ...
                <table id="books_table" data-sortcol="1" data-sortorder="desc" data-remote="<?php echo $remote_url ?>" class="ui data_table celled table responsive nowrap unstackable table_order"
                       style="width:100%">
                    <thead>
                    <tr>
