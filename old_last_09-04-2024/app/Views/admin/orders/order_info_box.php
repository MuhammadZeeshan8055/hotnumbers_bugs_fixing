...
if(!empty($order)) { ?>
    <div class="table-box">
        <label><?php echo !empty($title) ? $title: 'Order information'?></label>
        ...
        <form method="post" autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    if(!empty($order['customer_user'])) {
                        $user = $userModel->get_user($order['customer_user'],'fname,lname');
                    }else {
                        $user = 0;
                    }
                    ...
                    <div style="max-width: 320px;">
                        ...
                        <div>
                            ...
                            <div class="input_field mt-6">
                                ...
                                if($allowedit) { ?>
                                <div>
                                    <select name="customer" class="form-control customers_autocomplete" placeholder="Guest" value="<?php echo $order['customer_user'] ?>">
                                        <option value="" disabled>Guest</option>
                                        <?php if($user) { ?>
                                        <option value="<?php echo $order['customer_user'] ?>"><?php echo $user->fname . ' ' . $user->lname ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <?php }else {
            ...
            <?php if(empty($order['edit_mode']) && $allowedit) { ?>
                <div class="row mt-25">
                    <div class="col-md-12">
                        <button type="submit" name="save_order_information" value="1" class="btn btn-sm btn-primary">Save changes</button>
                        <br>
                        <br>
                    </div>
                </div>
