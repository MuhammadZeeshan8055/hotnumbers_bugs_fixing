<div class="container">
    ...
    <div class="datatable">
        ...
        <div class="books_listing">
            ...
            <table id="books_table" data-sortcol="1" data-sortorder="desc" data-remote="?get_table=1" data-filter='filter_by_status,filter_by_category' class="ui data_table table_order celled table responsive nowrap" style="width:100%">
                <thead>
                <tr>
                    <th width="30" data-orderable="false" data-searching="false">
