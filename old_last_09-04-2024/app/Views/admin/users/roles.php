        ...
        <div class="mt-60">
            <form method="post" style="max-width: 1100px">
                <fieldset>
                                ...
                                <div class="col-md-12">
                                    <div class="d-inline-block">
                                        <div class="input_field">
                                            <label>ID</label>
                                            <input name="role[id][<?php echo $i ?>]" ondblclick="this.removeAttribute('readonly'); this.focus()" readonly value="<?php echo $role->role ?>" title="Double click to edit" placeholder="ID">
                                        </div>
                                    </div>
                    ...
                    <div class="row mt-60">
                        <div class="col-md-12">
                            <button type="submit" name="save_roles" value="1" class="btn btn-primary btn-sm">Save changes</button>
                            &nbsp;
                            &nbsp;
                            <button type="button" onclick="add_role_input()" class="btn btn-secondary btn-sm">Add Role</button>
                        </div>
                    </div>
