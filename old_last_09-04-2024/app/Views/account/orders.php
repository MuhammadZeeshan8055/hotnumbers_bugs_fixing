                    ...
                    <div class="woocommerce-MyAccount-content">
                                ...
                                <div class="toolbar">
                                    ...
                                    foreach($order_counts as $status=>$count) {
                                        ...
                                        ?>
                                        <a href="?status=<?php echo $status ?>" class="btn btn-sm btn-primary <?php echo !$active ? 'bg-light color-red':'bg-red color-white' ?>" style="float: none;"><?php echo ucfirst($status) ?> (<?php echo $count ?>)</a>
                                        <?php
                                        }
                                        $idx++;
                                    }?>
                                        ...
                                        if(!empty($order['order_meta']))
                                        {
                                            ...
                                            <tr class="woocommerce-orders-table__row order">
                                                <td class="woocommerce-orders-table__cell">
                                                    <a href="<?php echo base_url('account/orders/view_order/'.$order_id)?>">#<?php echo $order_id; ?></a>
                                                </td>
                                                <td class="woocommerce-orders-table__cell">
