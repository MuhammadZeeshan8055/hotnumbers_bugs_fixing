                ...
                <div class="subscription_form" >
                    <form id="payment_form" method="post" class="validation" autocomplete="off" action="<?php echo site_url('coffee-club-subscription/checkout') ?>">
                                            ...
                                            if(!empty($form_fields['subscription-type'])) {
                                                foreach($form_fields['subscription-type'] as $value=>$name) {
                                                    ...
                                                    <div class="input_button">
                                                        <input type="radio" name="subscription-type" value="<?php echo $value ?>" required>
                                        ...
                                        <div>
                                            ...
                                            if(!empty($form_fields['duration'])) {
                                                ...
                                                foreach($form_fields['duration'] as $value=>$name) {
                                                    ?>
                                                    <div class="input_button">
                                                        <input type="radio" name="duration" value="<?php echo $value ?>" required>
                                                        <label><?php echo $name ?></label>
                                                    </div>
                                                    <?php
                                                }
                        ...
                        <div class="area products">
                            <div class="title">3. COFFEE</div>
                            <div class="content">
                                <div class="row-fluid">
                                    <article class="col-12 col-sm-12 flexbox fl options">
                                        <select id="subscription_coffee" name="subscription_coffee" class="select2" required>
                                            ...
                                            if(!empty($coffees)) {
                                                foreach($coffees as $coffee) {
                                                    $title = $coffee['title'];
                                                    $pid = $coffee['id'];
                                                    $iid = !empty($coffee['img']) ? json_decode($coffee['img'],true) : [''];
                                                    $image = !empty($iid) ? $media->get_media_src($iid[0]) : '';
                                                    ?>
                            ...
                            <div class="content">
                                <div class="row">
                                    <article class="col-md-8 col-sm-12 fl options">
                                        <p id="price_html" class="color-red f42"><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol"><?php echo currency_symbol ?></span><span id="subscription-price-text"></span> </bdi></span></p>
                                        <p>*Terms &amp; Conditions Apply</p>
                        ...
                        'grind': `<article class="col-md-4 col-sm-12 fl desc">
                                        <div>
                                                    <table width="100%">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <p class="text-justify"><strong>Turkish</strong> — Our finest coffee grind where the grinds are left in solution, unfiltered before sinking to the bottom of the cup. An intense and unique coffee ritual from Turkey.</p>
                                                            </td>
                                                            <td width="80" class="text-center">
                                                                <img src="<?php echo asset('images/icons/turkish_coffee_icon_small.png') ?>" width="60">
                                                            </td>
                                                        </tr>
                                                    </tbody></table>
                                                                                            </div>
                        ...
                        $('#coffee_variations').find('input:checked').each(function() {
                            ...
                            $.get(url,function(res) {
                               ...
                               if(typeof result !== "undefined") {
                                   const price = result.calculated_price;
                                   $('#subscription-price-text').text(price);
                               }
                            })
