    ...
    <div id="woocommerce-cart-form-div" class="container" style="top: 72px; ">
        ...
        if(!empty($cart['products'])) {
            ...
            <div class="woocommerce">
                <h1 class="align_center">Basket</h1>
                ...
                <table class="shop_table woocommerce-cart-form cart woocommerce-cart-form__contents" cellspacing="0">
                    ...
                    foreach($cart['products'] as $i=>$item) {
                        ...
                        $product_variations = $item['variation'];
                        $variation_id = 0;
                        $variation_display = [];
                        ...
                        $post_type = !empty($product->post_type) ? $product->post_type : 'product';
                    ...
                    foreach($cart['products'] as $i=>$item) {
                        ...
                        <div class="cart-box">
                            ...
                            <div class="content">
                                ...
                                <h4 class="price">Price: <bdi><span class="product-total-text"><?php echo _price($price * $item['quantity']) ?></span></bdi></h4>
