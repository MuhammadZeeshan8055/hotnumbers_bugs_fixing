...
$routes->match(['post', 'get'], 'account', 'LoginController::index');
$routes->match(['post', 'get'], 'login', 'LoginController::index');
$routes->post('register', 'LoginController::register_customer');
...
//  $routes->add('login_action', 'Account::login_action');
    ...
    $routes->get('orders/remake/(:num)', 'Account::order_remake/$1');
    ...
    $routes->get('logout', 'Account::logout_user');
});
...
$routes->get('workwithus', 'Page::workwithus');
...
$routes->group('admin', ['filter' => 'AdminFilter'], static function ($routes) {
    ...
    $routes->get('wholesale-requests', 'Admin/Users::wholesale_requests');
