...
<section class="flex-text margins_inherit " style="  ">
    <div class="container padding_inherit">
        <h1 class="page_title_2 " >PRIVACY POLICY</h1>
        <p class="text-block"><span><cite>Last updated: 27/02/2019</cite></span><br><br>
            Hot Numbers Coffee Roasters (“us”, “we”, or “our”) operates the Hot Numbers Wholesale website (the “Service”).<br><br>
            This page informs you of our policies regarding the collection, use and disclosure of Personal Information when you use our Service.<br><br>
        ...
        <div>
            ...
            <hr>
                <h2>Log Data</h2>
                <p>We collect information that your browser sends whenever you visit our Service (“Log Data”).</p>
