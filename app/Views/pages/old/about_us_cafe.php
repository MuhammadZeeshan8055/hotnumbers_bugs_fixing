<?php echo view("includes/header"); ?>
    ...
    <!--- section 1 --->
	<section class="full_container heading_box no_margins no_padding high_box " style="background-color: #0a0204;">
        <div class="overlay" style="opacity:0.2"></div>
        <div class="bg" style="background: url('<?php echo base_url('./assets/images/about-us-cafe/HotNumbersCoffee_CopyrightRichardFraser-0040.jpg') ?>') no-repeat;"></div>
            <div class="heading top-page">
                <h1>Hot Numbers <br/>Coffee Roasters</h1>
                <h2>Coffee | Music | Conversation</h2>                    
            </div>
        <div class=" "> </div>      
    </section>
    <!--- section 1 end --->
    ...
    <section id="triple_footer_box" class="triple_footer_box no_margins no_padding ">
		<a href="<?php echo base_url('gwydir_st') ?>" style="background-color: #e8003d; background-image:url('<?php echo base_url('./assets/images/about-us-cafe/gwydir-street.jpg') ?>');">
			<div class="info">
				<div class="title">
					<h3 >Gwydir St.</h3>
					<h4>Coffee Shop</h4>
		...
		<a href="<?php echo base_url('the_roastery') ?>" style="background-color: #555555; background-image:url('<?php echo base_url('./assets/images/about-us-cafe/roastery_.jpg') ?>');">
			<div class="info">
				<div class="title">
					<h3 >The Roastery</h3>
					<h4>Shepreth</h4>
		...
		<a href="<?php echo base_url('hotnumbers_menu') ?>" style="background-color: #777777; background-image:url('<?php echo base_url('./assets/images/about-us-cafe/background-1.jpg') ?>');">
			<div class="info">
				<div class="title">
					<h3 >The Menu</h3>
				</div>
