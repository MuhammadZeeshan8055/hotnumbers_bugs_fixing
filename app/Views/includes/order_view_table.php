<?php
    if(!empty($order_id)) {
        ...
        if($get_order) {
            ...
            ?>
            <h3 style="color: #d62034; display: block; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 18px; font-weight: bold; line-height: 130%; margin: 0 0 18px; text-align: left;">[Order# <?php echo _order_number($order_id) ?>] (<?php echo $date_created ?>)</h3>
