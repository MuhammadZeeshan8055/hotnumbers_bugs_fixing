    ...
    <div class="nav_container">
        <div class="menu-main-menu-container">
            <ul id="menu-main-menu" class="menu">
                ...
                <li
                    ...
                    <ul class="sub-menu">
                        ...
                        <?php /*<li class="menu-item"><a
                                    href="<?php echo base_url('shop/category/coffee') ?>">Coffee</a></li>
                        <li class="menu-item"><a
                                    href="<?php echo base_url('shop/category/kandula-tea') ?>">Kandula Tea</a></li>
                        <li class="menu-item"><a
                                    href="<?php echo base_url('shop/category/kandula-tea') ?>">Hot Chocolate</a></li>
                        <li class="menu-item">
                            <a href="<?php echo base_url('shop/category/barista-training') ?>">Barista Training</a></li>*/ ?>
                        ...
                        <?php
                            foreach($categories as $category) {
                                ...
                                ?>
                                <li class="menu-item"><a
                                            href="<?php echo base_url('shop/category/'.$category->slug) ?>"><?php echo $category->name ?></a></li>
                                <?php
                            }
                        ?>
                        ...
                        <li
                            class="menu-item mt-15" style="margin-top: 18px">
                            <a href="<?php echo base_url('coffee-club-subscription') ?>">Subscriptions</a></li>
                        <li
                            class="menu-item"
                            style="margin-bottom:;"><a href="<?php echo base_url('shop/category/equipment') ?>">Equipment</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    <a href="<?php echo base_url('the-roastery') ?>">The Roastery</a></li>
                <li class="menu-item">
                    <a href="<?php echo base_url('gwydir-st') ?>">Gwydir St.</a></li>
                <li class="menu-item">
                    <a href="<?php echo base_url('trumpington-st') ?>">Trumpington St.</a></li>
                <li class="separator"></li>
                <li
                    class="gap_above"><a
                            href="<?php echo base_url('hotnumbers-menu') ?>">Our Menu</a></li>
                <li class="menu-item">
                    <a href="<?php echo base_url('about-us-cafe') ?>">About Hot Numbers</a></li>
                <li class="menu-item">
                    <a href="<?php echo base_url('gigs-events') ?>">Gigs &#038; Events</a></li>
                ...
                <li class="menu-item">
                    <a href="<?php echo base_url('become-wholesale-customer') ?>">Wholesale</a></li>
        ...
        <div class="top_nav">
            <div class="top_menu">
                <div class="menu-top-menu-container">
                    <ul id="menu-top-menu" class="menu">
                        ...
                        if(is_logged_in() || is_admin()) {
                            ...
                            <li
                                class="nmr-logged-in show-mob menu-item">
                            ...
                            <li class="nmr-logged-in menu-account menu-item"><a class="logout-btn" href="<?php echo base_url('account/logout') ?>"> Logout</a>
                            </li>
                            <?php
                        }else {
                            ?>
                            <li
                                class="nmr-logged-out menu-account show-mob menu-item">
                ...
                <div class="cart-icon" style="margin-top:-50px;  margin-left: 354px;">
                  ...
                  <path class="st0"
                        d="M25.7,15.9v-5.5c0-3.1-2.6-5.7-5.7-5.7s-5.7,2.6-5.7,5.7v5.5H5.2l2.5,19.5h24.6l2.5-19.5H25.7z M15.5,10.4 c0-2.5,2-4.5,4.5-4.5s4.5,2,4.5,4.5v5.5h-9.1V10.4z M31.2,34.1H8.8L6.5,17h7.7v7.1h1.2V17h9.1v7.1h1.2V17h7.7L31.2,34.1z"></path>
            </svg>
                    </a>
                </div>
