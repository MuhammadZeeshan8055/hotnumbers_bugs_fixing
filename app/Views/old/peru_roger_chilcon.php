            ...
            <div class="body woocommerce wrapper">
              <div class="flex-text">
                  <div class="container no_padding">
                    <!-- gallery pics --->
                    <?php include 'sliderflex_peru_roger.php';?>
                    <!-- gallery pics --->
                    ...
                    <div class="product_content">
                      <div class="cont">
                        <article class="flex-block">
                          <h4 class="p_title">Peru &#8211; Roger Chilcon</h4>
                          <p> This Beautiful coffee comes from Roger Chilcon Flores who is the owner of 3 hectares of coffee in the El Diamante village of San Jose de Lourdes district. Roger managers the picking, processing and packing of his family's surrounding farms. The high altitude of the coffee provides a pronounced Grapefruit flavour which we found balanced very nicely with the Tea richness found in our cupping. This coffee is truly an all rounder, a rich espresso with hints of sweetness, or a complex tea like pour over. </p>
                ...
                <div class="container">
                  <section class="related products">
		                <h2>Related products</h2>
                          ...
                          <img width="300" height="200" src="<?php echo base_url('./assets/images/rwanda-bwenda-441/Fredy-Pineda-300x200.jpg') ?>" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" loading="lazy" srcset="<?php echo base_url('./assets/images/rwanda-bwenda-441/Fredy-Pineda-300x200.jpg') ?> 300w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Fredy-Pineda-300x200.jpg') ?> 1024w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Fredy-Pineda-300x200.jpg') ?> 768w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Fredy-Pineda-300x200.jpg') ?> 1536w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Fredy-Pineda-300x200.jpg') ?> 600w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Fredy-Pineda-300x200.jpg') ?> 1600w" sizes="(max-width: 300px) 100vw, 300px" /><a href="https://hotnumberscoffee.co.uk/product/honduras-fredy-pineda/" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">    </a>
                          <a href="<?php echo base_url('rwanda_bwenda_441') ?>">
                            <div class="details">
                              <div class="content">
                        ...
                        <li class="product type-product post-3488 status-publish instock product_cat-coffee has-post-thumbnail taxable shipping-taxable purchasable product-type-variable">
                          <a href="<?php echo base_url('rwanda_bwenda_441') ?>">
                        ...
                        <li class="product type-product post-28145 status-publish last instock product_cat-coffee has-post-thumbnail taxable shipping-taxable purchasable product-type-variable">
                          <a href="<?php echo base_url('rwanda_bwenda_441') ?>">
