            ...
            <div class="body woocommerce wrapper">
              <div class="flex-text">
                  <div class="container no_padding">
                    <!-- gallery pics --->
                    <?php include 'sliderflex_colombia.php';?>
                    <!-- gallery pics --->
                    ...
                    <div class="product_content">
                      <div class="cont">
                        <article class="flex-block">
                          <h4 class="p_title"> Colombia &#8211; El Diviso </h4>
                          <p>
		                ...
		                <ul class="products columns-4">		
                            <li class="product type-product post-25445 status-publish first instock product_cat-coffee has-post-thumbnail taxable shipping-taxable purchasable product-type-simple">
                                <a href="<?php echo base_url('rwanda_bwenda_441') ?>">
                                    <img width="300" height="200" src="<?php echo base_url('./assets/images/rwanda-bwenda-441/902734_449844438433942_106142970_o-300x225.jpg') ?>" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" loading="lazy" srcset="<?php echo base_url('./assets/images/rwanda-bwenda-441/902734_449844438433942_106142970_o-300x225.jpg') ?> 300w, <?php echo base_url('./assets/images/rwanda-bwenda-441/902734_449844438433942_106142970_o-300x225.jpg') ?> 1024w, <?php echo base_url('./assets/images/rwanda-bwenda-441/902734_449844438433942_106142970_o-300x225.jpg') ?> 768w, <?php echo base_url('./assets/images/rwanda-bwenda-441/902734_449844438433942_106142970_o-300x225.jpg') ?> 1536w, <?php echo base_url('./assets/images/rwanda-bwenda-441/902734_449844438433942_106142970_o-300x225.jpg') ?> 600w, <?php echo base_url('./assets/images/rwanda-bwenda-441/902734_449844438433942_106142970_o-300x225.jpg') ?> 2000w" sizes="(max-width: 300px) 100vw, 300px" />
                                                        ...
                                                        <h2 class="woocommerce-loop-product__title">Coffee Pack (3 x 250g)</h2>                
                                                            <span class="price">
                                                                <span class="woocommerce-Price-amount amount">
                                                                    <span class="woocommerce-Price-currencySymbol">&pound;25.00</span></span>                
                                                                </span>
                                                    </div>
                                                </div>
                                </a>
                            ...
                            <li class="product type-product post-18257 status-publish instock product_cat-coffee has-post-thumbnail taxable shipping-taxable purchasable product-type-variable">
                                <a href="<?php echo base_url('rwanda_bwenda_441') ?>">
                                    <img width="300" height="200" src="<?php echo base_url('./assets/images/rwanda-bwenda-441/RFP_HN-2598-1-300x225.jpg') ?>" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" loading="lazy" srcset="<?php echo base_url('./assets/images/rwanda-bwenda-441/RFP_HN-2598-1-300x225.jpg') ?> 300w, <?php echo base_url('./assets/images/rwanda-bwenda-441/RFP_HN-2598-1-300x225.jpg') ?> 1024w, <?php echo base_url('./assets/images/rwanda-bwenda-441/RFP_HN-2598-1-300x225.jpg') ?> 768w, <?php echo base_url('./assets/images/rwanda-bwenda-441/RFP_HN-2598-1-300x225.jpg') ?> 1536w, <?php echo base_url('./assets/images/rwanda-bwenda-441/RFP_HN-2598-1-300x225.jpg') ?> 600w, <?php echo base_url('./assets/images/rwanda-bwenda-441/RFP_HN-2598-1-300x225.jpg') ?> 2000w" sizes="(max-width: 300px) 100vw, 300px" />
                                    <a href="<?php echo base_url('rwanda_bwenda_441') ?>" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">    </a>
                                        <a href="<?php echo base_url('rwanda_bwenda_441') ?>">
                                            <div class="details">
                                                <div class="content">
				            ...
				            <li class="product type-product post-28145 status-publish instock product_cat-coffee has-post-thumbnail taxable shipping-taxable purchasable product-type-variable">
                                <a href="<?php echo base_url('rwanda_bwenda_441') ?>">
                                    <img width="300" height="225" src="<?php echo base_url('./assets/images/rwanda-bwenda-441/Rocko-Mountain-300x225.jpg') ?>" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" loading="lazy" srcset="<?php echo base_url('./assets/images/rwanda-bwenda-441/Rocko-Mountain-300x225.jpg') ?> 300w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Rocko-Mountain-300x225.jpg') ?> 1024w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Rocko-Mountain-300x225.jpg') ?> 768w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Rocko-Mountain-300x225.jpg') ?> 600w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Rocko-Mountain-300x225.jpg') ?> 1280w" sizes="(max-width: 300px) 100vw, 300px" />
                                    <a href="<?php echo base_url('rwanda_bwenda_441') ?>" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">    </a>
                                        <a href="<?php echo base_url('rwanda_bwenda_441') ?>">
                                            <div class="details">
                                                <div class="content">
                            ...
                            <li class="product type-product post-30114 status-publish last instock product_cat-coffee has-post-thumbnail taxable shipping-taxable purchasable product-type-variable">
                                <a href="<?php echo base_url('rwanda_bwenda_441') ?>">
                                    <img width="300" height="200" src="<?php echo base_url('./assets/images/rwanda-bwenda-441/Rocko-Mountain-300x225.jpg') ?>" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" loading="lazy" srcset="<?php echo base_url('./assets/images/rwanda-bwenda-441/Rocko-Mountain-300x225.jpg') ?> 300w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Rocko-Mountain-300x225.jpg') ?> 1024w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Rocko-Mountain-300x225.jpg') ?> 768w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Rocko-Mountain-300x225.jpg') ?> 1536w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Rocko-Mountain-300x225.jpg') ?> 600w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Rocko-Mountain-300x225.jpg') ?> 1600w" sizes="(max-width: 300px) 100vw, 300px" />
                                    <a href="<?php echo base_url('rwanda_bwenda_441') ?>" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">    </a>
                                        <a href="<?php echo base_url('rwanda_bwenda_441') ?>">
                                            <div class="details">
                                                <div class="content">
