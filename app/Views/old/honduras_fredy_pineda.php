            ...
            <div class="body woocommerce wrapper">
              <div class="flex-text">
                  <div class="container no_padding">
                    <!-- gallery pics --->
                    <?php include 'Sliderflex_honduras_fredy.php';?>
                    <!-- gallery pics --->
                    ...
                    <div class="product_content">
                      <div class="cont">
                        <article class="flex-block">
                          <h4 class="p_title">Honduras &#8211; Fredy Pineda</h4>
                          <p> 
                          ...
                          <tbody>
                            <tr>
                                <th>Tasting Notes</th>
                                <td>Burnt Caramel | Dried Fruits | Apple</td>
                            </tr>
                            <tr>
                                <th>Region <script>document.getElementById('region').innerText = 'Corquin, Copan';</script></th>
                                    <td>Corquin, Copan</td>
                            </tr>
                            <tr>
                                <th>Producer </th>
                                <td>Fredy Rolando Pineda</td>
                            </tr>
                            <tr>
                                <th>Elevation <th>
                                <td>1200 masl</td>
                      ...
                      <hr>
                        <div class="product_info">
                          ...
                          <p>
                            <p>Fredy Rolando Pineda has been involved with coffee production all his life. He inherited 2 ha of farm land &#8216;Finca Fredy&#8217; from his father. He is part of the Aruco Cooperative and is one of 33 producers involved in a micro-lot program. He has been producing specialty micro lots since 2016 and receives advice from the technicians at Aruco about farm management and soil fertility to help produce good quality cherry and and prevent pests and disease.</p>
                            <p>The producers will receive about 70% of the FOB price for their micro lots. This year the harvest for all producers was extremely difficult with increased rains during the harvest and a lack of pickers meaning a large amount of coffee was lost from either falling to the ground or swelling and splitting on the tree.</p>
                            <p>All the processing for the Micro Lot&#8217;s takes place at the Aruco mill to centralise and have greater control over the process to create consistent procedures, but also to reduce the risk on the producer. The mill is also at 800masl which gives a drier more stable climate to dry the coffee compared to up at the farms where the weather can be less predictable.</p>
                            <p>The coffee will be delivered to the mill where they assess the cherry and decide on the process for the coffees depending on space. The cherry is cleaned and washed and then floated to remove any immatures.</p>
                            <p>The coffee is then taken to the beds where it is dried for between 20 -30 days weather depending where it is turned hourly.</p>
                          </p>
                        </div>
                  </div>
                </div>
                  ...
                  <section class="related products">
		            <h2>Related products</h2>
		                  <ul class="products columns-4">                  
                           	<li class="product type-product post-33564 status-publish first instock product_cat-coffee has-post-thumbnail taxable shipping-taxable purchasable product-type-variable">
                                <a href="<?php echo base_url('rwanda_bwenda_441') ?>">
                                    <img width="300" height="200" src="<?php echo base_url('./assets/images/rwanda-bwenda-441/Roger-Chilcon.jpg') ?>" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" loading="lazy" srcset="<?php echo base_url('./assets/images/rwanda-bwenda-441/Roger-Chilcon.jpg') ?> 300w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Roger-Chilcon.jpg') ?> 1024w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Roger-Chilcon.jpg') ?> 768w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Roger-Chilcon.jpg') ?> 1536w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Roger-Chilcon.jpg') ?> 600w, <?php echo base_url('./assets/images/rwanda-bwenda-441/Roger-Chilcon.jpg') ?> 1600w" sizes="(max-width: 300px) 100vw, 300px" />
                                    ...
                                    <div class="details">
                                        <div class="content">
                                            <h2 class="woocommerce-loop-product__title">Peru &#8211; Roger Chilcon</h2>                
                                                <span class="price">
                                                    <span class="woocommerce-Price-amount amount">From <span class="woocommerce-Price-currencySymbol">&pound;</span>10.30</span>                
                                                </span>
                                        </div>
                                    </div>
                                </a>
