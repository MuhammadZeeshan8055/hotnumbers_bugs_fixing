...
<div class='test-slider-1'>
    <div class="child-1 h-400px"> 
      <img src="./assets/images/blogs/IMG-20220415-WA0008-300x225.jpg" style='height: 100%; width: 100%; object-fit: cover '> 
    </div>
    <div class="child-2 h-400px"> 
      <img src="./assets/images/blogs/IMG-20220415-WA0010-225x300.jpg" style='height: 100%; width: 100%; object-fit: cover '> 
    </div>
    <div class="child-3 h-400px" > 
      <img src="./assets/images/blogs/IMG_0456-300x300.jpg" style='height: 100%; width: 100%; object-fit: cover'> 
    </div>
    <div class="child-4 h-400px"> 
      <img src="./assets/images/blogs/IMG_0337-240x300.jpg" style='height: 100%; width: 100%; object-fit: cover'> 
    </div>
    <div class="child-1 h-400px"> 
      <img src="./assets/images/blogs/IMG-20220415-WA0008-300x225.jpg" style='height: 100%; width: 100%; object-fit: cover '> 
    </div>
