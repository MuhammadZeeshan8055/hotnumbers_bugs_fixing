...
<section class=" heading_box no_margins no_padding high_box home_banner" style="background-color:#0a0000; ">
    ...
    <div class="container">
      ...
      <div class="has_btn_bottom has_btn2_bottom" style="text-align: center;">
        ...
        <a class="button button_lrg button_bottom" href="<?php echo base_url('work-with-us') ?>"> Work with us! </a>
      </div>
    </div>
</section>
<!--section 1 end -------------->
...
<?php
    $sectionBlocks = [
        ...
        [
            ...
            'link'=>base_url('become-wholesale-customer'),
        ...
        [
            ...
            'link'=>base_url('shop/category/barista-training'),
