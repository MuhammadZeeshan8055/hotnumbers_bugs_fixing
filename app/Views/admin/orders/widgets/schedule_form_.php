...
if(!empty($order['order_items'][0])) {
    ...
    $subscription['period_'] = $subscription['expire'];

    if($subscription['period'] === "week" && strstr($subscription['expire'],'months')) {
        ...
        <div class="row shop_subscription_form no-gutters">
            ...
            <div class="col-md-12 pt-15">
                <div class="subscription-plan-expire">
                    <select class="select2" value="<?php echo !empty($subscription['period_']) ? $subscription['period_'] : '' ?>" data-search="false" name="subscription_setting[expire]">
        ...
        <div class="row pt-15">
            <div class="col-md-12">
                <div class="input_field">
                    ...
                    <input type="text" name="subscription_setting[next_payment_date]" class="datepicker form-control" value="<?php echo !empty($next_payment) ? date('d/m/Y',strtotime($next_payment)) : '' ?>">
                </div>
            </div>
        </div>
        <div class="row pt-15">
        ...
        <div class="row pt-15">
            <div class="col-md-12">
                <div class="input_field">
                    ...
                    <input type="text" name="subscription_setting[schedule_end]" <?php echo !$schedule_end ? 'disabled':'' ?> class="datepicker form-control" value="<?php echo $schedule_end ? date('d/m/Y',strtotime($schedule_end)) : '' ?>">
                </div>
            </div>
        </div>
