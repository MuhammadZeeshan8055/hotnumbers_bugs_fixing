    ...
    <form action="<?php echo base_url(ADMIN . '/settings') ?>"
        ...
        <div class=" row" style="width:80%">
            ...
            <div class=" col-lg-6">
                <div class="input_field mt-20">
                    ...
                    <input type="email" name="website[recruitment_email]" value="<?php echo @$setting_row['recruitment_email'] ?>" required>
                </div>
            </div>
        ...
        <div class="row" style="width:80%">
            ...
            <div class="col-md-6 input_field mt-10">
                ...
                <input type="text" name="website[vat_number]" value="<?php echo @$setting_row['vat_number'] ?>">
            </div>

            <div class="col-md-6 input_field mt-10">
                <label>Wholesale Invoice Payment Details</label>
                <textarea type="text" rows="10" name="website[invoice_payment_details]"><?php echo @$setting_row['invoice_payment_details'] ?></textarea>
            </div>

            <div class="col-md-6 input_field mt-10">
                <label>Wholesale Invoice Footer Text</label>
                <textarea type="text" rows="2" name="website[invoice_footer_text]"><?php echo @$setting_row['invoice_footer_text'] ?></textarea>
            </div>
