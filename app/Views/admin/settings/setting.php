    ...
    <div class="settings ">
        ...
        <div class="tabs">
            <ul id="tab-links">
                ...
                <li><a href="#tab-tax">Tax</a></li>
                <li><a href="#tab-ship-methods">Shipping</a></li>
                <li><a href="#tab-subscriptions">Subscriptions</a></li>
                <?php if(env('braintree.enable')) { ?>
                    <li><a href="#tab-braintree">Braintree</a></li>
                <?php } ?>

                <?php if(env('squareup.enable')) { ?>
                    <li><a href="#tab-squareup">Squareup</a></li>
                <?php } ?>
                <li><a href="#mail-smtp">Email SMTP</a></li>
            </ul>
            <?php
            $setting_row = [
                'title'=>'',
            ...
            <?php echo view('admin/settings/mail_smtp',$this->data) ?>
