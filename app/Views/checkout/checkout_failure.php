...
<div class="wrapper">
    <div id="woocommerce-cart-form-div" class="container" style="top: 72px; ">
        ...
        <div class="woocommerce">
            ...
            <div class="text-center">Thank you. Your order<b>#<?php echo _order_number($order_id) ?></b> has been received. <a id="printlink" href="#" onclick="window.print()" style="float: right;color: #d62135;">Print</a> </div>
